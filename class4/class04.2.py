...
movies = [
        {'movie_name': 'Avengers Endgame', 'ticket_price': 'Price 300', 'genre': 'Action', 'age_restriction': '13'},
        {'movie_name': 'Inception', 'ticket_price': 'Price 280', 'genre': 'Sci-Fi', 'age_restriction': '13'},
        {'movie_name': 'It', 'ticket_price': 'Price 180', 'genre': 'Horror', 'age_restriction': '18'},
        {'movie_name': 'The Notebook', 'ticket_price': 'Price 250', 'genre': 'Romantic', 'age_restriction': '13'},
        {'movie_name': 'Harry Potter and the Sorcerer\'s Stone', 'ticket_price': 'Price 260', 'genre': 'Fantasy', 'age_restriction': 'G'}
    ]

x = int(input("1. Show movie 2.Buy ticket"))
if  x == 1 :
